...
UINT azure_iot_mqtt_publish_string_telemetry(AZURE_IOT_MQTT* azure_iot_mqtt, CHAR* label, CHAR* value)
{
    CHAR mqtt_publish_topic[100];

    printf("Sending device telemetry\r\n");
    printf("%s\r\n", value);
    ...
    return mqtt_publish(azure_iot_mqtt, mqtt_publish_topic, value);
}
